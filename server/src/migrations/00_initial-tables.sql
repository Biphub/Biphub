...
DROP TABLE IF EXISTS `Pipelines`;
CREATE TABLE IF NOT EXISTS `Pipelines` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `title` VARCHAR(255), `description` VARCHAR(255), `entryApp` VARCHAR(255), `entryType` TEXT, `sequence` JSONB, `nodes` JSONB, `edges` JSONB, `dataMaps` JSONB, `createdAt` DATETIME NOT NULL, `updatedAt` DATETIME NOT NULL);
