...
DROP TABLE IF EXISTS `Actions`;
CREATE TABLE IF NOT EXISTS `Actions` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `title` VARCHAR(255), `description` VARCHAR(255), `docRef` VARCHAR(255), `trigger` TEXT, `imports` JSONB, `exports` JSONB, `createdAt` DATETIME NOT NULL, `updatedAt` DATETIME NOT NULL, `PodId` INTEGER REFERENCES `Pods` (`id`) ON DELETE CASCADE ON UPDATE CASCADE);
